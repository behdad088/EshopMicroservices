...
public class OrderCreatedEventCustomization : ICustomization
{
    public void Customize(IFixture fixture)
    {
        fixture.Customize<OrderCreatedEvent.Address>(x => x
        ...
        fixture.Customize<OrderCreatedEvent.OrderItem>(x => x
        ...
        fixture.Customize<OrderCreatedEvent.Payment>(x => x
        ...
        fixture.Customize<OrderCreatedEvent>(x => x
            ...
            .With(r => r.ShippingAddress, fixture.Create<OrderCreatedEvent.Address>())
            .With(r => r.OrderItems, [fixture.Create<OrderCreatedEvent.OrderItem>()])
            .With(r => r.PaymentMethod, fixture.Create<OrderCreatedEvent.Payment>())
        ...
        fixture.Customize<CloudEvent<OrderCreatedEvent>>(c => c
            ...
            .With(e => e.Data, fixture.Create<OrderCreatedEvent>())
        );
    }
}