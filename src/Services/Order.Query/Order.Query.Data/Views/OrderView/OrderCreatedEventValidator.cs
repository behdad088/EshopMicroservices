...
public class OrderCreatedEventValidator : AbstractValidator<OrderCreatedEvent>
{
    ...
    private class TotalPriceValidator : AbstractValidator<OrderCreatedEvent>
    {
        ...
        private static void ValidateTotalPrice(OrderCreatedEvent @event, ValidationContext<OrderCreatedEvent> context)
        {
    ...
    private class OrderItemValidator : AbstractValidator<OrderCreatedEvent.OrderItem>
    {
    ...
    private class PaymentValidator : AbstractValidator<OrderCreatedEvent.Payment>
    {
        public PaymentValidator()
        {
            RuleFor(x => x.Cvv).NotEmpty()
                ...
                .Length(3).WithMessage("CVV length is not valid.");
