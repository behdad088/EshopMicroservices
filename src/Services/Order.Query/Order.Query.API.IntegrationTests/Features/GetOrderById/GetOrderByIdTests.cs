...
public class GetOrderByIdTests(ApiFactory apiFactory) : IAsyncLifetime
{
    ...
    [Theory]
    [DomainDataAuto]
    public async Task GetSystemAllocationTemplate_WhenInvalidOrderId_ShouldReturnBadRequest(Request request)
    {
        // Arrange
    ...
    [Theory]
    [DomainDataAuto]
    public async Task GetSystemAllocationTemplate_WhenInvalidCustomerId_ShouldReturnBadRequest(Request request)
    {
        // Arrange
    ...
    [Theory]
    [DomainDataAuto]
    public async Task GetSystemAllocationTemplate_WhenNoToken_ShouldReturnUnauthorized(Request request)
    {
        // Act
    ...
    [Theory]
    [DomainDataAuto]
    public async Task GetSystemAllocationTemplate_WhenNoPermission_ShouldReturnForbidden(Request request)
    {
        // Act
        var response = await _client
            .SetFakeBearerToken(FakePermission.GetPermissions(
    ...
    [Theory]
    [DomainDataAuto]
    public async Task GetSystemAllocationTemplate_WhenHavingPermissionButWrongUser_ShouldReturnForbidden(Request request)
    {
        // Act
        var response = await _client
            .SetFakeBearerToken(FakePermission.GetPermissions(
    ...
    [Theory]
    [DomainDataAuto]
    public async Task GetSystemAllocationTemplate_WhenExistingOrderId_ShouldReturnExpectedResponse(Request request)
    {
        // Arrange
